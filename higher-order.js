...
// function justEvens(theArray) {
//   theArray.filter(% 2 === 0);
// }
let evenNumbers = mixedNumbers.filter(function onlyEvens(theVal) {
  return theVal % 2 === 0;
})
...
//Code Here
let totalPopulation = populations.reduce(function(acc, curVal, curIndex, array){
  return acc + curVal;
})
